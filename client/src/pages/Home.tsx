...
const Home = () => {
    const [offerListings, setOfferListings] = useState<FormData[]>([]);
    const [saleListings, setSaleListings] = useState<FormData[]>([]);
    const [rentListings, setRentListings] = useState<FormData[]>([]);
